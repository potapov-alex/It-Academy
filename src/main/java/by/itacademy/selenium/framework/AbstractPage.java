...
public abstract class AbstractPage {
    ...
    public void waitForPageToLoad() {
        new WebDriverWait(driver, Duration.ofSeconds(DRIVER_WAIT_TIME)).until(
    ...
    public void waitForElementInvisible(By by) {
        Wait<WebDriver> wait = new WebDriverWait(driver, Duration.ofSeconds(DRIVER_WAIT_JQUERY_TIME));
    ...
    public boolean waitForElementToDisappear(By byLocator) {
        Wait<WebDriver> wait = new WebDriverWait(driver, Duration.ofSeconds(DRIVER_WAIT_TIME),
                Duration.ofSeconds(100));
        return (Boolean) wait.until(ExpectedConditions.invisibilityOfElementLocated(byLocator));
    }
